...
export default function Dashboard({ darkMode }) {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            const response = await analyzeText(text, language, image);
            setResult(response);
            // Show feedback modal after result
    ...
    return (
        <div className="container">
            ...
            <div className="hero">
                ...
                <img src="/logo.png" alt="FactWeave Logo" className="hero-logo" />
            ...
            <div className="glass-card">
                ...
                <div className="form-group">
                    <LanguageSelector value={language} onChange={setLanguage} darkMode={darkMode} />
                </div>
