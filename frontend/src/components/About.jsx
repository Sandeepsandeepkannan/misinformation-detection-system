        ...
        <div className="container" style={{ paddingTop: '4rem', paddingBottom: '4rem' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                ...
                <p style={{
                    ...
                    We're building a production-ready, knowledge-enhanced multilingual misinformation detection system that combines cutting-edge AI with knowledge graphs to provide fast, accurate, and explainable fact-checking in 15+ languages.
                </p>
            </div>
            ...
            <div style={{ marginBottom: '4rem' }}>
                ...
                <div style={{
                    ...
                    {[
                        { icon: '🌍', title: '15+ Languages', desc: 'Multilingual support including English, Spanish, French, German, Chinese, Hindi, Arabic, and more' },
