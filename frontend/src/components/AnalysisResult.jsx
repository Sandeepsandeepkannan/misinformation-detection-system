    ...
    return (
        ...
        >
            ...
            <div className="glass-card" style={{
                borderLeft: `6px solid ${isAuthentic ? '#10b981' : '#ef4444'}`,
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
                    <div>
                        <h2 style={{
                            fontSize: '2.25rem',
                            fontWeight: 700,
                            color: isAuthentic ? '#10b981' : '#f87171',
                            marginBottom: '0.5rem',
                            textShadow: isAuthentic
                                ? '0 0 20px rgba(16, 185, 129, 0.3)'
                                : '0 0 20px rgba(239, 68, 68, 0.3)'
                        }}>
                            {isAuthentic ? '✅ AUTHENTIC CONTENT' : '⚠️ MISINFORMATION DETECTED'}
                        </h2>
                        ...
                        {result.detailed_claims.map((claim, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    style={{
                                        borderLeft: `4px solid ${claimIsAuthentic ? '#10b981' : '#ef4444'}`,
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ flex: 1 }}>
                                            <div style={{
                                                ...
                                                {claimIsAuthentic ? '✓ AUTHENTIC' : '✗ MISINFORMATION'}
                                            </div>
                                            <p style={{
                                                fontSize: '1.05rem',
                                        ...
                                        <div style={{
                                            fontSize: '2rem',
                                            fontWeight: 700,
                                            color: claimIsAuthentic ? '#10b981' : '#f87171'
                                        }}>
            ...
            <div style={{
                ...
                <div>
                    <ConfidenceChart
                        ...
                        verdict={result.verdict || 'MISINFORMATION'}
